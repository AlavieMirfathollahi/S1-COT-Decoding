...
for filenum = 1:length(filenames)
    ...
    for i_Act_Pas = 1:2
        ...
        [Prep_data, Feature_classify, Labels] =...
            FeatureExtrection_for_Classification(Prep_data, need_kernel,...
            kernel_ord_classification, i_Act_Pas, Fea_name, window_MTfeaClssification,...
            overlapp_MTfeaClssification, window_statFeaClssification,...
            overlapp_statFeaClssification, index_before, index_after);
